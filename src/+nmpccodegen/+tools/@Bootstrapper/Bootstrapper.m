classdef Bootstrapper
    ...
    methods(Static,Access = private)
        function location_repo = get_repo_location()
            ...
            relative_location_windows = '\src\+nmpccodegen\+tools\@Bootstrapper\Bootstrapper.m';
            relative_location_unix = '/src/+nmpccodegen/+tools/@Bootstrapper/Bootstrapper.m';
            Folder = strrep(Folder,relative_location_windows,'\kernel');
            Folder = strrep(Folder,relative_location_unix,'/kernel');
